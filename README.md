...
### [Abrir Plan Rescate](https://casadoa018-dotcom.github.io/plan-rescate/)
...
1. Abre la [aplicación publicada](https://casadoa018-dotcom.github.io/plan-rescate/).
2. Pulsa **Probar el tutor gratis** para hacer una consulta inmediata, o **Crear mi plan** para configurar un objetivo.
3. Escribe una duda real y revisa la explicación y la comprobación final.
...
La versión publicada fue sometida a una batería de 120 casos:

- **86 verificaciones ejecutables superadas**.
- **0 fallos detectados** en las verificaciones ejecutadas.
- **34 comprobaciones** requieren hardware, permisos del dispositivo o un modelo de IA disponible en el navegador.
...
Esta es una versión de prueba. El acceso indicado como Pro durante la beta no implica una compra ni una suscripción activa.
